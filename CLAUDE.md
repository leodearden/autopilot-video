...
Use `project_root: "/home/leo/src/autopilot-video"` for all task operations.
...
### Starting a session
1. Search memory for project context: `search(query="project overview and current status", project_id="autopilot_video")`
2. Check task tree: `get_tasks(project_root="/home/leo/src/autopilot-video")`
